...
@ComponentScan(basePackages = {"risk.engine.job", "risk.engine.service", "risk.engine.db", "risk.engine.common", "risk.engine.crawler", "risk.engine.components", "risk.engine.metric"})
